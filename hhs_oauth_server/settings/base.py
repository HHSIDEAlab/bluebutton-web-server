...
print("---")
print("--- base.py settings")
print("---")
print("---  FHIR_CLIENT_CERTSTORE: ", env("FHIR_CLIENT_CERTSTORE", "UNSET"))
print("---")
print("---  FHIR_CLIENT_CERTSTORE_REL: ", env("FHIR_CLIENT_CERTSTORE_REL", "UNSET"))
print("---")
print("---  FHIR_CERT_FILE: ", env("FHIR_CERT_FILE", "UNSET"))
print("---")
print("---  FHIR_KEY_FILE: ", env("FHIR_KEY_FILE", "UNSET"))
print("---")
